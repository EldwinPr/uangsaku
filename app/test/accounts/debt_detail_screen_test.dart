...
void main() {
  ...
  Future<void> pumpScreen(WidgetTester tester, int debtId) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: MaterialApp(home: DebtDetailScreen(accountId: debtId)),
      ),
    );
  ...
  testWidgets(
    'NFR-4 / FR-11: the screen renders paid and remaining, the settle control is enabled with no dialog on tap, and tapping settles through notifier → DAO → emission',
    (tester) async {
